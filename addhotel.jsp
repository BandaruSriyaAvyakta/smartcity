	...
	<form action="inserthotel" method="post" enctype="multipart/form-data">
		...
		<table align=center>
			...
			<tr>
				...
				<td><textarea name="hoteldescription"></textarea></td>
			</tr>
			...
			<tr>
				<td><label>Hotel Phone</label></td>
				<td><input type="text" name="hotelphone" required="required"
					step="0.01" /></td>
			</tr>
			...
			<tr>
				<td><label>Hotel Email</label></td>
				<td><input type="email" name="hotelemail" required="required"
					step="0.01" /></td>
			</tr>

			<tr>
				<td><label>Hotel Link</label></td>
				<td><input type="text" name="hotellink" /></td>
			</tr>
