	...
	<form action="inserthospital" method="post"
		...
		<table align=center>
			...
			<tr>
				...
				<td><input type="text" name="hospitalname" required="required" /></td>
			</tr>
			...
			<tr>
				...
				<td><textarea name="hospitaldescription"></textarea></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="hospitaladdress"
					required="required" step="0.01" /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" name="hospitalphone" required="required"
					step="0.01" /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="email" name="hospitalemail"
					required="required" step="0.01" /></td>
			</tr>

			<tr>
				<td><label>Website Link</label></td>
				<td><input type="text" name="hospitalbalink" /></td>
			</tr>
			...
			<tr>
				<td><label>Directions Link</label></td>
				<td><input type="text" name="hospitaldlink" /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="file" name="hospitalimage" required="required" /></td>
			</tr>
