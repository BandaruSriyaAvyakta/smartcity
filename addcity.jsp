...
<body>
	...
	<form action="insertcity" method="post" enctype="multipart/form-data">
		...
		<table align=center>
			...
			<tr>
				...
				<td><input type="text" name="citynamestyle" required="required" /></td>
			</tr>
			
			<tr>
				<td><label>City Image 1</label></td>
				<td><input type="file" name="cityimage1" required="required" /></td>
			</tr>
			
			<tr>
				<td><label>City Image 2</label></td>
				<td><input type="file" name="cityimage2" required="required" /></td>
			</tr>
