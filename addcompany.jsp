...
<body>
	...
	<form action="insertcompany" method="post"
		...
		<table align=center>
			...
			<tr>
				<td><label>Company Website Link</label></td>
				<td><input type="text" name="companylink" /></td>
			</tr>
			...
			<tr>
				<td><label>Compnay Image</label></td>
				<td><input type="file" name="companyimage" required="required" /></td>
			</tr>
