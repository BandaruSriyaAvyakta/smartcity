...
<h3 align=center  style="color : red " >${message} </h3>
	...
	<form action="insertmall" method="post" enctype="multipart/form-data">
		...
		<table align=center>
			...
			<tr>
				<td><label>Shopping Mall Name</label></td>
				<td><input type="text" name="mallname" required="required" /></td>
			</tr>
			...
			<tr>
				<td><label>Shopping Mall Description</label></td>
				<td><textarea name="malldescription"></textarea></td>
			</tr>
			...
			<tr>
				<td><label>Shopping Mall Link</label></td>
				<td><input type="text" name="malllink" /></td>
			</tr>
			...
			<tr>
				<td><label>Shopping Mall Image</label></td>
				<td><input type="file" name="mallimage" required="required" /></td>
			</tr>
